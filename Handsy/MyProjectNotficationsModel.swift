...
//        let sv = UIViewController.displaySpinner(onView: view)
        ...
        Alamofire.request("http://smusers.promit2030.co/Service1.svc/GetAllNotificationByProjectId", method: .get, parameters: Parameters, encoding: URLEncoding.default).responseJSON { response in
            debugPrint(response)
