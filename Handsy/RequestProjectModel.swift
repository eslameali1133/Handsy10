...
class RequestProjectModel: NSObject {
    ...
    func GetProjectByCustID(view: UIView, VC: UIViewController) {
        ...
        Alamofire.request("http://smusers.promit2030.co/Service1.svc/GetProjectByCustID", method: .get, parameters: Parameters, encoding: URLEncoding.default).responseJSON { response in
            debugPrint(response)
